            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form action="{{ route('filter.classrooms') }}" method="POST">
                        {{ csrf_field() }}
                        <select name="Grade_id" onchange="this.form.submit()" class="selectpicker" data-style="btn-info"
                                required>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                    id="exampleModalLabel">{{ trans('My_Classes_trans.edit_class') }}</h5>
                                ...
                                <div class="modal fade" id="delete{{ $classroom->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                    id="exampleModalLabel">{{ trans('My_Classes_trans.delete_class') }}</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
        ...
        <div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                            id="exampleModalLabel">{{ trans('My_Classes_trans.add_class') }}</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name_class_en"
                                                           class="mr-sm-2">{{ trans('My_Classes_trans.Name_class_en') }}
                                                        :</label>
                                                    <input id="Name_class_en" name="Name_class_en" class="form-control"
                                                           type="text"/>
                                                </div>
                                                <div class="col">
                                                    <label for="Name_en"
